...
Identify the highest revenue and most profitable product categories.
   ...
   ![Sales and Profit by Category](images/sales_&_profit_by_category.png)
...
Understand which product sub-categories contribute most to revenue and profitability.
   ...
   ![Sales and Profit by Sub-Category](images/sales_&_profit_by_subcategory.png)
...
Identify best-performing and underperforming products.
   ...
   ![Top and Lowest 10 Products by Sales](images/top_&_lowest_10_products_by_sales.png)
...
Evaluate business performance across different regions.
   ...
   ![Sales and Profit by Region](images/sales_&_profit_by_region.png)
...
Identify high-performing and loss-generating states.
   ...
   ![Top 10 Sales Profit Loss by State](images/top_10_sales_profit_loss_by_state.png)
...
Analyze business performance at city level.
   ...
   ![Top 10 Sales Profit Loss by City](images/top_10_sales_profit_loss_by_city.png)
...
Recognize valuable customers and customers requiring business attention.
   ...
   ![Top 10 Sales Profit Loss by Customer](images/top_10_sales_profit_loss_by_customer.png)
...
Determine products that maximize or reduce profitability.
   ...
   ![Top and Lowest 10 Products by Profit](images/top_&_lowest_10_products_by_profit.png)
...
Analyze customer shipping preferences.
   ...
   ![Ship Mode Distribution](images/ship_mode.png)
...
Understand how discounts affect profitability.
   ...
   ![Average Profit by Discount](images/avg_profit_by_discount.png)
